...
keyword_extractor = Agent(
  ...
  backstory="""
    You extract key terms from the context in {language}.
...
keyword_researcher = Agent(
  ...
  backstory="""
    You generate definitions in the{language}
...
keyword_researcher_single = Agent(
  role='Keyword Researcher',
  goal='Research the keyword {keyword} and create definitions in {language}.',
  backstory="""
    You generate definitions in the {language}.
    You research keywords to help students learn more about the topic.
    If your tools do not work, you write definitions on your own.
